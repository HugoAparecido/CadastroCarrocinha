    ...
    <section>
        <div class="principal">
            ...
            if ($nome_foto == "")
                ...
                $sql = "UPDATE animal SET nome = '$nome', foto = '$nome_foto', especie = '$especie', raca = '$raca', data_nascimento = '$dataNascimentoFormatada', castrado = $castrado, id_pessoa = $pessoa WHERE id = $id";
